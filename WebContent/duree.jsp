...
<body class="form-v6">
	<div class="page-content">
		<div class="form-v6-content">
			...
			<form class="form-detail" action="DureeServlet" method="post">
				<h2>Calcul Durée</h2>
				<div class="form-row">
					<input type="text" name="annuite" id="full-name" class="input-text" placeholder="Annuité (DH)" required>
				</div>
				<div class="form-row">
					<input type="text" name="cap" id="your-email" class="input-text" placeholder="Capital (DH)" required>
				</div>
				<div class="form-row">
					<input type="text" name="taux" id="password" class="input-text" placeholder="Taux (decimale)" required>
				</div>
				<div class="form-row">
					<input type="text" name="comfirm-password" id="comfirm-password" class="input-text" placeholder="Resultat"
					value="<%= session.getAttribute("Durée") %>">
				</div>
